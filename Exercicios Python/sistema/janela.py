...
acervo = [
    Livro("As aventuras aventureiras", "Vitor M. Martins", 2009),
    Livro("Jesus vs Buda no X1", "João Vitor A.", 2002),
    Livro("Quem nasce no Brasil é brasileiro", "Guilherme Miau", 2023)
]

#Declaração da lista de emprestímos
emprestimos = []
#Criação do usuário
usuario = Usuario("Eric", "1920129")
