...
livro = Livro("O temor do Sabio", "Patrick Rothfuss", 2014)
...
daniel = Usuario("Daniel", 999)
emp = Emprestimo(livro, daniel, "02/10/2026")
...
emprestimo = [emp, Emprestimo(acervo[1], daniel, "02/10/2026")]
